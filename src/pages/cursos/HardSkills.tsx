  ...
  useEffect(() => {
    const fetchCursos = async () => {
      try {
        ...
        if (user) {
          const { data: inscricoesData, error: inscricoesError } =
            await supabase
        ...
        toast.error("Erro ao carregar cursos para PCD");
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Desenvolva competências técnicas essenciais para sua área
            profissional
          </p>
        </div>
        ...
        {cursos.length === 0 && (
          <div className="text-center py-12">
            <h3 className="text-xl font-medium text-gray-900 mb-2">
              Nenhum curso de Hard Skills encontrado
            </h3>
            <p className="text-gray-500">
              Estamos trabalhando para adicionar mais cursos nesta categoria.
            </p>
          </div>
        )}
      </div>
